...
Source0  : https://files.pythonhosted.org/packages/19/8c/69b98cc8be481b18dc41f266bf8d164213c14ccbb687abd6a157231fcfe6/pytest-timeout-1.4.1.tar.gz
...
%prep
%setup -q -n pytest-timeout-1.4.1
cd %{_builddir}/pytest-timeout-1.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592411942
...
cp %{_builddir}/pytest-timeout-1.4.1/LICENSE %{buildroot}/usr/share/package-licenses/pytest-timeout/8216f3d66db8d3c8edf0e6c29f7db60c021f3490
