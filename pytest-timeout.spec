...
Source0  : https://files.pythonhosted.org/packages/12/71/5dad1e94ad5b96318b76e492682cc7a3a6d0f995d2713962091fd331787a/pytest-timeout-1.3.1.tar.gz
...
%prep
%setup -q -n pytest-timeout-1.3.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1532446094
