...
%prep
%setup -q -n pytest-timeout-1.4.2
cd %{_builddir}/pytest-timeout-1.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594926127
...
cp %{_builddir}/pytest-timeout-1.4.2/LICENSE %{buildroot}/usr/share/package-licenses/pytest-timeout/8216f3d66db8d3c8edf0e6c29f7db60c021f3490
