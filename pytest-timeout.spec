...
Version  : 1.3.0
Release  : 34
URL      : https://pypi.debian.net/pytest-timeout/pytest-timeout-1.3.0.tar.gz
Source0  : https://pypi.debian.net/pytest-timeout/pytest-timeout-1.3.0.tar.gz
Summary  : py.test plugin to abort hanging tests
Group    : Development/Tools
License  : MIT
Requires: pytest-timeout-python3
Requires: pytest-timeout-license
...
%prep
%setup -q -n pytest-timeout-1.3.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1530987780
python3 setup.py build -b py3

%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/pytest-timeout
cp LICENSE %{buildroot}/usr/share/doc/pytest-timeout/LICENSE
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/pytest-timeout/LICENSE
