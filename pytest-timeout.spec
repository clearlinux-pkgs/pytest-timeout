...
Version  : 2.0.0
Release  : 59
URL      : https://files.pythonhosted.org/packages/a5/a7/612a48dfb84bfe281218826e4877ae1c52e59d6743fc0e5d04ee84700e94/pytest-timeout-2.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/a5/a7/612a48dfb84bfe281218826e4877ae1c52e59d6743fc0e5d04ee84700e94/pytest-timeout-2.0.0.tar.gz
...
%prep
%setup -q -n pytest-timeout-2.0.0
cd %{_builddir}/pytest-timeout-2.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633963657
...
cp %{_builddir}/pytest-timeout-2.0.0/LICENSE %{buildroot}/usr/share/package-licenses/pytest-timeout/8216f3d66db8d3c8edf0e6c29f7db60c021f3490
